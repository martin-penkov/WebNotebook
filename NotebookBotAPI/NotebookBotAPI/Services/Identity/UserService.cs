...
namespace NotebookBotAPI.Services
{
    public class UserService : IUserService
    {
        ...
        public UserService(IOptions<AppSettings> appSettings, NotebookDbContext context)
        {
        ...
        {
            var user = _context.Users.FirstOrDefault(x => x.UserName == model.Username && x.PasswordHash == model.Password);
